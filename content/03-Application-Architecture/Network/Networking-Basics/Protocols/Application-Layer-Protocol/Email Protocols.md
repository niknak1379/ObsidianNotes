...
## SMTP
you use SMTP to send or POP3 to receive the email. They use [[TCP(Transmission Control Protocol)]] for the [[04-Transport Layer]] protocols to ensure that the email data is not lost. 
