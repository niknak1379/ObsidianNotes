...
## How it works
* [[03-Application-Architecture/Network/Networking-Basics/Protocols/00-Protocol Models0/TCP,IP-Model&Layers/07-Application Layer]] sends lots of raw data and TCP segments the data(divides in chunks) adds headers, checksums, etc...
* It might collect the data from the [[03-Application-Architecture/Network/Networking-Basics/Protocols/00-Protocol Models0/TCP,IP-Model&Layers/03-Network Layer]](Network layer itself divides the data into smaller chunks so transport layer has to put them back together)
* Congestion Control
