...
## Transport Layer
Has its own protocols of how the data will be transferred ([[03-Application-Architecture/Network/Networking-Basics/Protocols/Transport-Layer-Protocols0/TCP(Transmission Control Protocol)]], [[03-Application-Architecture/Network/Networking-Basics/Protocols/Transport-Layer-Protocols0/UDP(User Datagram Protocol)]]).
...
Logical Addressing (handling [[03-Application-Architecture/Network/Networking-Basics/Protocols/Network-Layer-Protocols0/IP(Internet Protocol)|IP Address]]ing), moves data packets from source to destination.
