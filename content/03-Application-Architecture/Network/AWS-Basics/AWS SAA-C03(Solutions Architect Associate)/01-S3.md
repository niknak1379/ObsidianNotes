...
## S3 Features
### S3 Inventory
takes inventory ob objects in s3 bucket on a repeating schedule so you have an audit history of object changes. it will output the inventory into another s3 bucket.
