...
MPLS is basically a layer 2.5(neither [[02-Data Link Layer]] nor [[03-Network Layer]]). It adds a new layer to the OSI model by adding a label designating which networks are allowed to access the traffics on that packet. Thats how the Virtual circuit is created. 
